/**
 * dynamic_tiles.js – Dashboard tile grid management module
 */

export class GridManager {
    constructor(options = {}) {
        this.MAX_COL = options.maxCol || 3;
        this.MAX_ROW = options.maxRow || 3;
        ...
        this.containerSelector = options.containerSelector || '.overview-container';
        
        // Content type registry
        this.CONTENT_TYPES = options.contentTypes || {
        ...
        // Maps datapoint prefixes to allowed content types
        this.DATAPOINT_CONTENT_MAP = options.datapointContentMap || {
    ...
    addNewTile(config = null) {
        ...
        if (config) {
            ...
            // Werte beim Hinzufügen abgreifen und || null Fallback anwenden
